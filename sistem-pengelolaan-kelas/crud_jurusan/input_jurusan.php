							...
							<form action="proses_input_jurusan.php" method="POST">
								...
								<div class="form-group">
									...
									while ($akun = mysqli_fetch_array($query)) { ?>
										<div align="center" class="card-header">Form Input Jurusan Pada Tahun Ajaran <?php echo $akun['nama_tahun_ajaran']; ?> </div>
										<div class="form-group">
								...
								<div class="form-group">
									<label for="formGroupExampleInput2">Nama Jurusan</label>
									<input type="text" class="form-control" id="formGroupExampleInput2" name="nama_jurusan" placeholder="">
								</div>
							
								<button type="submit" class="btn btn-primary">Submit</button>
								<a class="btn btn-danger" href="tampil_jurusan.php" role="button">Batal</a>
							</form>
						</div>
					</div>
					<!-- </div> -->
