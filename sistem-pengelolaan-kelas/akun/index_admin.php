...
$no = 1;
$id_admin=$_SESSION['auth']['id_admin'];
		...
		<!-- Main Content -->
			<div id="content">
				...
				<div class="container-fluid">
					<!-- Page Heading -->
					<div class="clearfix">
						<h1 class="h3 mb-4 text-gray-800" align="center">Manajemen Akun</h1>
					...
					<hr><br>
	                    <?php while($akun = mysqli_fetch_assoc($query)) : ?>
	                  	<div class="container">
	                  		<div class="card">
					        	<div class="card-header">Form Edit Data Diri</div>
					        		<div class="card-body">
					                  	<form action="edit_akun_admin.php" method="POST">
					                  	<div class="form-group">
							              <label for="nama_guru">Nama</label>
										  <input hidden type="text" class="form-control" name="id_admin" value="<?php echo $akun['id_admin'] ?>" required>
