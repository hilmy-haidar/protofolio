      ...
      <div class="col-xl-10 col-lg-12 col-md-9">
        ...
        <div class="card o-hidden border-0 shadow-lg my-5">
          <div class="card-body p-0">
            ...
            <div class="row">
              <div class="col-lg-5 d-none d-lg-block mt-5 ml-5">
                <img src="img/login.png" width="370" height="365">
              </div>
              <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-gray-900" style="text-align: center; text-decoration-color: black; font-family: sans-serif;" >
                    <h3>SISTEM MANAJEMEN PEMBELAJARAN</h2><hr>
                  </div>
