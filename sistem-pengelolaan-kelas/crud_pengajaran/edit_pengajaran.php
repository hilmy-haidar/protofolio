        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    $query1 = mysqli_query($koneksi, "SELECT * FROM guru WHERE id_guru = '$id_guru'");
                                ...
                                <div class="card-body">
                                    <form action="proses_edit.php" method="POST">
                                        ...
                                        <div class="form-group" >
                                            <input type="hidden" class="form-control" name="id_guru" value="<?php echo $akun['id_guru'] ?>" required>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" value="guru" name="role" class="form-control" required>
                                        </div>

                                        <div class="form-group">
                                            <label>Jumlah</label>
                                            <input type="text" value="<?php echo $akun['jumlah'] ?>" name="jumlah" class="form-control" required>
                                        </div>
