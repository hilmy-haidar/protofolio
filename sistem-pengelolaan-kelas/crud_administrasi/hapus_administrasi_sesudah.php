...
$id_administrasi_sesudah = $_GET['id_administrasi_sesudah'];
...
$query = mysqli_query($koneksi, "DELETE FROM administrasi_sesudah WHERE id_administrasi_sesudah = $id_administrasi_sesudah");
if($query){
	...
	{
		if($data_guru['jumlah']>$data_guru['value_sesudah1'])
		{
