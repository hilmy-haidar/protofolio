		...
		<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
			...
			<div id="content-wrapper" class="d-flex flex-column">
				...
				<div id="content">
					...
					<div class="card">
						<div class="card-header" style="text-align: center; font-size: 180%; " >Pilih Tahun Ajaran</div>
						<div class="card-body">
						
							<div class="table-responsive">
                                
                            <form Method="POST" action="proses_backup.php">
							<table class="tabel-form " cellpadding="4" cellspacing="0" border="0" align="center">
								<tbody>
									<tr bgcolor="blue">
										<td class="text-white">Pilih : </td>
									</tr>
									<tr>
										<td>
                                            ...
                                            <option >Tahun Ajaran</option>
												...
												?>
													<option value="<?php echo $data['id_tahun_ajaran']; ?>"><?php echo $data['nama_tahun_ajaran']; ?></option>
												<?php } ?>
											</select>
										</td>
									</tr>
