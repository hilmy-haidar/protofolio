	...
	<div id="wrapper">
		<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
			...
			<hr class="sidebar-divider my-0">
				...
				<li class="nav-item">
				<li class="nav-item">
				<a class="nav-link" href="../jurusan/home_jurusan.php?id_tahun_ajaran=<?php echo $id_tahun_ajaran?>&id_jurusan=<?php echo $id_jurusan?>">
			...
			<div id="content-wrapper" class="d-flex flex-column">
				...
				<div id="content">
					...
					<div class="container-fluid">
						<!-- Page Heading -->
							<h1 class="h3 mb-4 text-gray-800" style="text-align: center;">Kelas</h1>
						<hr>
						<?php if (check_flash_message('sukses')): ?>
							...
							<div class="row mt-3">
				                ...
				                <div class="col-md-4 mb-3">
						            ...
						            <a role="button" href="../mapel/analisis_kimia/analisis_kimia_x.php?id_kelas=<?= $post['id_kelas'] ?>
									&id_tahun_ajaran=<?php echo $id_tahun_ajaran ?>
									&id_jurusan=<?php echo $id_jurusan ?>" 
									class="btn btn-primary "><?php echo $post['nama_kelas'];?></a>
						    	</div>
	            				<?php endforeach; ?>
			                </div>
			                </div>
