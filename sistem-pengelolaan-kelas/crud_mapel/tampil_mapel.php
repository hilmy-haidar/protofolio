	...
	<div id="wrapper">
		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				...
				<div class="card">
					<div class="card-header" style="text-align: center; font-size: 180%; ">Tahun Ajaran </div>
												...
												<div class="dropdown">
													...
													<div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
														...
														<?php while ($akun1 = mysqli_fetch_array($query1)) { ?>
															<a class="dropdown-item" href="pilih_jurkel.php?id_tahun_ajaran=<?php echo $akun1['id_tahun_ajaran'] ?>"><?php echo $akun1['nama_tahun_ajaran']; ?></a>
