							...
							<form action="proses_input_kelas.php" method="POST">
								...
								<div class="form-group">
									...
									while ($akun = mysqli_fetch_array($query)) { ?>
										<div align="center" class="card-header">Form Input Kelas Pada Jurusan <?php echo $akun['nama_jurusan']; ?> </div>
										<div class="form-group">
											<input hidden class="form-control" type="text" name="id_jurusan" value="<?php echo $akun['id_jurusan']; ?>" required>
								...
								<div class="form-group">
									...
									<input type="text" class="form-control" id="formGroupExampleInput2" name="nama_kelas" placeholder="">
								</div>
							
								<button type="submit" class="btn btn-primary">Submit</button>
								<a class="btn btn-danger" href="tampil_kelas.php" role="button">Batal</a>
							</form>
						</div>
					</div>
					<!-- </div> -->
