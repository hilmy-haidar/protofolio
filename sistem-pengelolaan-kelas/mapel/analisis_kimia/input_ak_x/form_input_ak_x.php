		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				...
				<h1 class="h3 mb-4 text-gray-800" style="text-align: center;">
					Input File Buku Administrasi Guru Pada Tahun Ajaran <?php echo $data_ta['nama_tahun_ajaran'] ?>
								...
								<form action="../../../proses_input.php" method="POST" enctype="multipart/form-data">
									...
									<div class="form-group row">
										<div class="form-group" style="padding-left: 13px">
											<label for="judul">Perhitungan Minggu Efektif :</label>
											<input type="file" class="form-control-file" name="perhitungan_minggu_efektif" id="perhitungan_minggu_efektif" placeholder="Perhitungan Minggu Efektif" required>
										</div>
										<div class="form-group">
											<label for="formGroupExampleInput2">Program Tahunan :</label>
											<input type="file" class="form-control-file" id="formGroupExampleInput2" name="program_tahunan" placeholder="Program Tahunan">
										</div>
										<div class="form-group">
											<label for="formGroupExampleInput2">Program Semester :</label>
											<input type="file" class="form-control-file" id="formGroupExampleInput2" name="program_semester" placeholder="Program Semester">
										</div>
									</div>
									<div class="form-group row">
										<div class="form-group" style="padding-left: 13px">
											<label for="formGroupExampleInput2">Silabus :</label>
											<input type="file" class="form-control-file" id="formGroupExampleInput2" name="silabus" placeholder="Silabus">
										</div>
										<div class="form-group">
											<label for="formGroupExampleInput2">Analisis KKM :</label>
											<input type="file" class="form-control-file" id="formGroupExampleInput2" name="analisis_kkm" placeholder="Analisis KKM">
										</div>
										<div class="form-group">
											<label for="formGroupExampleInput2">RPP :</label>
											<input type="file" class="form-control-file" id="formGroupExampleInput2" name="rrp" placeholder="RPP">
										</div>
									</div>
