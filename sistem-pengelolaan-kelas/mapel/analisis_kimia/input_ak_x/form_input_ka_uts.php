...
$sql = "SELECT * FROM administrasi_kel_uts";
		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				...
				<h1 class="h3 mb-4 text-gray-800" style="text-align: center;">
					Input File Kelengkapan Administrasi UTS Pada Tahun Ajaran <?php echo $data_ta['nama_tahun_ajaran'] ?>
				...
				<div class="container">
					<div class="container">
						...
						<div class="card">
							...
							<div class="card-body">
								<form action="../../../proses_input_uts.php" method="POST" enctype="multipart/form-data">
