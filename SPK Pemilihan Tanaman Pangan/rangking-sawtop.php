 ...
 * ------------------------------------------- */
$query2 = $pdo->prepare('SELECT id_tanaman, inisial_tanaman, nama_tanaman FROM tanaman WHERE periode=1');
$query2->execute();
...
foreach ($kriterias as $kriteria) :
    ...
    foreach ($tanamans as $tanaman) :
        ...
        $query3 = $pdo->prepare('SELECT nilai FROM nilai_tanaman
			WHERE id_tanaman = :id_tanaman AND id_kriteria = :id_kriteria AND pt=1');
...
<div class="main-content-row">
    <div class="container clearfix">
        ...
        <div class="main-content main-content-full the-content">
            ...
            <h2>Periode Tanam 1 (Januari - April)</h2>
            ...
            <div class="main-content-row">
                <div class="container clearfix">
                    ...
                    <div class="main-content main-content-full the-content">
                        ...
                        ?>
                        <h3>Hasil Perangkingan Periode Tanam 1 (Januari-April)</h3>
                        <table class="pure-table pure-table-striped">
                            <thead>
                                <tr>
