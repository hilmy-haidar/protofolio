...
if (isset($_POST['submit'])) :
	...
	if (empty($errors)) :
		...
		$handle = $pdo->prepare('INSERT INTO tanaman (inisial_tanaman, nama_tanaman, tanggal_input) VALUES (:inisial_tanaman, :nama_tanaman, :tanggal_input)');
		...
		if (!empty($kriteria)) :
			foreach ($kriteria as $id_kriteria => $nilai) :
				$handle = $pdo->prepare('INSERT INTO nilai_tanaman (id_tanaman, id_kriteria, nilai) VALUES (:id_tanaman, :id_kriteria, :nilai)');
				$handle->execute(array(
...
<div class="main-content-row">
	<div class="container clearfix">
		...
		<div class="main-content the-content">
			<h1>Tambah Data Alternatif Tanaman</h1>
