...
<div class="main-content-row">
    <div class="container clearfix">
        ...
        <?php include_once('template-parts/sidebar-lapangan3.php'); ?>

        <div class="main-content the-content">
            <h3>Penilaian Berdasarkan data lapangan (periode tanam 3)</h3>

            <form action="tambah-tanaman3.php?pesan=panduan" method="POST">
