...
?>
	...
	<div class="container clearfix">
		...
		<div class="main-content the-content">
			...
			<h1>List Data Alternatif Tanaman (periode tanam 3)</h1>
			
			<?php
			$query = $pdo->prepare('SELECT * FROM tanaman WHERE periode=3');			
			$query->execute();
			...
			// Fetch semua tanaman
			$query2 = $pdo->prepare('SELECT id_tanaman, inisial_tanaman FROM tanaman WHERE periode=3');
			$query2->execute();			
