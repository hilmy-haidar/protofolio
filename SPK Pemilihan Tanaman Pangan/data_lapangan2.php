...
<div class="main-content-row">
    <div class="container clearfix">
        ...
        <?php include_once('template-parts/sidebar-lapangan2.php'); ?>

        <div class="main-content the-content">
            <h3>Penilaian Berdasarkan data lapangan (periode tanam 2)</h3>

            <form action="tambah-tanaman2.php?pesan=panduan" method="POST">
