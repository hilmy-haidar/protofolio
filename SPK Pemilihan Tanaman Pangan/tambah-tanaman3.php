...
if (isset($_POST['submit'])) :
	...
	if (empty($errors)) :
		...
		redirect_to('list-tanaman3.php?status=sukses-baru');
...
<div class="main-content-row">
	<div class="container clearfix">
		...
		<?php include_once('template-parts/sidebar-tanaman3.php'); ?>

		<div class="main-content the-content">
			<h1>Tambah Data Alternatif Tanaman (periode tanam 3)</h1>
			...
			<form action="tambah-tanaman3.php" method="post">
			...
			<?php
				...
				<a href="data_lapangan3.php">Penilaian Berdasarkan Data Lapangan</a>
