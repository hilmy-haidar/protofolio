...
if (isset($_POST['submit'])) :
	...
	if (empty($errors)) :
		...
		redirect_to('list-tanaman2.php?status=sukses-baru');
...
<div class="main-content-row">
	<div class="container clearfix">
		...
		<div class="main-content the-content">
			<h1>Tambah Data Alternatif Tanaman (periode tanam 2)</h1>
			...
			<form action="tambah-tanaman2.php" method="post">
			...
			<?php
				...
				<a href="data_lapangan2.php">Penilaian Berdasarkan Data Lapangan</a>
